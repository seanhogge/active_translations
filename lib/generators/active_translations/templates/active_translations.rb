ActiveTranslations.configure do |config|
  ...
  config.auth_uri = ENV.fetch("GOOGLE_TRANSLATION_AUTH_URI", "https://accounts.google.com/o/oauth2/auth", :missing_google_translation_auth_uri)
  config.token_uri = ENV.fetch("GOOGLE_TRANSLATION_TOKEN_URI", "https://oauth2.googleapis.com/token", :missing_google_translation_token_uri)
